...
Straight off of the sequencing platform, data are most often in a BCL format. However, most (or many) sequencing facilities will have already "demultiplexed" (see later in this tutorial) these data into individual FASTQ files. If this sounds similar to the FASTA files you're more familiar with, it's because it is! It's worth taking a minute to review the structure of a FASTA format. 
